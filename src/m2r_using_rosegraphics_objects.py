...
#                attach_to(self,window_or_canvas), clone(self), and move_center_to(self,x,y).
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle
#             objects have:
#                center, outline_color, and radius.
#
#     f. What does a RoseWindow RENDER method do?
#            It allows the stuff to be drawn.
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            If it is not there, the window will close automatically.
#
